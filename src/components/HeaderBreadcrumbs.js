        ...
        <>
            { isPageOderDetail && <Box className='header-order-detail'>
                <Stack direction="row" spacing={ 1 } alignItems="center">
                    ...
                    <ChevronRight color={ ColorStyles.Foundation.Black[ 600 ] } />
                </Stack>
            ...
            { ispageOderPackage === true &&
                <Box className='header-oder-package'>
                    <Breadcrumbs
                        separator={ <ChevronRight color={ ColorStyles.Foundation.brown[ 500 ] } /> }
                    >
                        { pageOderPackage }
                    </Breadcrumbs>
...

            {
                isPageList === true &&
                <Breadcrumbs
                    separator={ <ChevronRight color={ ColorStyles.Foundation.YellowBrown[ 500 ] } /> }
                    sx={ { marginBottom: "24px" } }
                >
                    { PageList }
                </Breadcrumbs>
